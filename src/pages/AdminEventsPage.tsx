    ...
    <AnimatedPage>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-zinc-900/40 border border-white/5 rounded-2xl p-6 backdrop-blur-sm relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
              {(['realm', 'server', 'developer', 'builder'] as OTMCategory[]).map((cat) => {
                ...
                return (
                  <div key={cat} className="p-4 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-between group/item hover:border-realm-green/30 transition-all">
                    <div>
                      <h3 className="text-[10px] font-pixel text-white uppercase tracking-widest leading-none mb-1">{cat} of the month</h3>
                      <div className="flex items-center gap-2">
                        <div className={`w-1.5 h-1.5 rounded-full ${isActive ? 'bg-realm-green shadow-[0_0_8px_rgba(78,196,78,0.5)]' : 'bg-zinc-600'}`} />
        ...
        <FramerIn delay={0.2} className="space-y-6">
          <div className="bg-zinc-900/40 border border-white/5 rounded-2xl overflow-hidden backdrop-blur-sm h-full">
