      ...
      <div className="mb-10 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        ...
        <FramerIn delay={0.1}>
          <button
            ...
            className="flex items-center gap-2 px-6 py-4 bg-realm-green text-zinc-950 rounded-2xl font-headline font-bold text-xs uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-lg shadow-realm-green/20"
          >
            <Plus size={16} />
            Create New Post
          </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPosts.map((post, idx) => (
            <motion.div
              ...
              className="group bg-zinc-900/40 border border-white/5 rounded-3xl overflow-hidden flex flex-col shadow-xl hover:border-white/10 transition-all"
            >
              {/* Card Image */}
              <div className="h-48 relative overflow-hidden bg-zinc-800">
                ...
                <div className="absolute top-4 left-4 flex flex-col gap-2">
                  <span className="px-3 py-1 bg-black/60 backdrop-blur-md border border-white/10 rounded-full text-[10px] font-headline font-bold uppercase tracking-widest text-realm-green">
                    {post.status}
                  </span>
                  {post.is_featured && (
                    <span className="px-3 py-1 bg-realm-green text-zinc-950 backdrop-blur-md border border-white/10 rounded-full text-[10px] font-headline font-bold uppercase tracking-widest flex items-center gap-1.5 shadow-lg shadow-realm-green/20">
                ...
                <div className="mt-auto space-y-4 pt-4 border-t border-white/5">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-[10px] font-headline font-bold uppercase tracking-widest text-white/60 hover:text-white hover:bg-white/10 transition-all"
                    >
                      <Edit2 size={12} />
                      Edit
                    </button>
                    <button
                      ...
                      className="w-10 h-10 flex items-center justify-center bg-red-500/10 border border-red-500/20 rounded-xl text-red-500 hover:bg-red-500 hover:text-white transition-all"
                    >
                      <Trash2 size={16} />
                    </button>
                  </div>
