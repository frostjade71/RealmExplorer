...
export function EmptyState({ title = "No Results", message = "We couldn't find any blocks matching your search.", action }: { title?: string, message?: string, action?: React.ReactNode }) {
  return (
