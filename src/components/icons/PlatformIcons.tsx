export const FabricIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round" clipRule="evenodd" viewBox="0 0 24 24">
...
export const ForgeIcon = ({ className }: { className?: string }) => (
  <svg className={className} fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="1.5" clipRule="evenodd" viewBox="0 0 24 24">
...
export const QuiltIcon = ({ className }: { className?: string }) => (
  <svg className={className} xmlnsXlink="http://www.w3.org/1999/xlink" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="2" clipRule="evenodd" viewBox="0 0 24 24">
    <defs>
...
export const NeoForgeIcon = ({ className }: { className?: string }) => (
...
export const VanillaIcon = ({ className }: { className?: string }) => (
...
export const SpigotIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 332 284" strokeLinejoin="round" fill="none" stroke="currentColor" strokeWidth="24px">
...
export const PurpurIcon = ({ className }: { className?: string }) => (
  <svg className={className} fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="1.5" clipRule="evenodd" viewBox="0 0 24 24">
    <defs>
