        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          ...
          >
            ...
            <div className="p-6 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
              <h2 className="font-pixel text-white text-lg tracking-tight">Request Category</h2>
              <button 
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full h-40 bg-white/5 border border-white/10 rounded-2xl p-5 text-white font-body text-sm leading-relaxed focus:outline-none focus:ring-2 focus:ring-realm-green/50 focus:border-realm-green/50 placeholder:text-white/20 resize-none transition-all shadow-inner"
                  />
                </div>
              </div>

              <div className="flex items-start gap-3 p-4 bg-realm-green/5 border border-realm-green/10 rounded-2xl text-realm-green/70">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={onClose}
                  className="flex-1 py-4 rounded-2xl font-headline font-bold text-white/40 hover:text-white hover:bg-white/5 transition-all text-xs uppercase tracking-widest"
                >
                  Cancel
                </button>
                <motion.button
                  ...
                  className={`flex-[2] py-4 rounded-2xl font-headline font-bold flex items-center justify-center gap-3 transition-all text-xs uppercase tracking-widest ${
